...
export default function SignupPage() {
      ...
      <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center px-4">
        <div className="w-full max-w-[600px] bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            <h1 className="text-[26px] font-bold font-pretendard mb-2">회원가입</h1>
            <p className="text-[14px] text-gray-600">회원 유형을 선택해주세요</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-[13px] text-gray-600">여행 상품을 이용하시는 고객</p>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-[13px] text-gray-600">여행 상품을 판매하시는 업체</p>
              </div>
            </button>
          </div>
  ...
  // 일반 회원의 경우 소셜 로그인 선택 화면
  if (step === 'select-social') {
    return (
      <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center px-4">
        <div className="w-full max-w-[480px] bg-white rounded-2xl shadow-lg p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-center flex-1">
              <h1 className="text-[24px] font-bold font-pretendard">일반 회원 가입</h1>
            </div>
            <div className="w-12" />
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              <span className="text-[15px] font-semibold">이메일로 계속하기</span>
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-[540px] bg-white rounded-2xl shadow-lg p-8">
        <div className="flex items-center justify-between mb-6">
          <button
            onClick={() => userType === UserType.CUSTOMER ? setStep('select-social') : setStep('select-type')}
            className="text-gray-400 hover:text-gray-600"
          >
            ← 뒤로
          </button>
          <div className="text-center flex-1">
            <h1 className="text-[24px] font-bold font-pretendard">
              {userType === UserType.CUSTOMER ? '일반 회원' : '여행사 회원'} 가입
            </h1>
          </div>
          <div className="w-12" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div>
            <label htmlFor="name" className="block text-[13px] font-medium text-gray-700 mb-1.5">
              {userType === UserType.CUSTOMER ? '이름' : '담당자명'} *
            </label>
            <input
              id="name"
              type="text"
